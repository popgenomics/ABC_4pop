...
help += "\t\t\033[1;32;40mExample: ./ABC_4pop.py 2M_2N ab_AC_bd_Cd 10\033[0m\n"
help += "\t\t\033[1;32;40mThis will run 10 multilocus simulations with a secondary contact between population A and C (M hetero + N hetero), and unidirectional gene flow from D to C\033[0m\n"
...
my_command = "priorgen_4pop_v2.py"
